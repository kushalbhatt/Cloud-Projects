...
public class Messaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://gcmdemoapp-63192.appspot.com/_ah/api/";
  ...
  public class MessagingEndpoint {
     ...
     *
     * @param content the {@link com.example.kushal.myapplication.backend.messaging.model.MessageData}
     * @return the request
     */
    public SendMessage sendMessage(com.example.kushal.myapplication.backend.messaging.model.MessageData content) throws java.io.IOException {
    ...
    public class SendMessage extends MessagingRequest<Void> {
       ...
       * @since 1.13
       */
      protected SendMessage(com.example.kushal.myapplication.backend.messaging.model.MessageData content) {
